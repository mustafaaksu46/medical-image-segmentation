...
3. Finally, run the Three_models_train_test_visual_default_DeepLabv3+.py script after setting the parameters. This script performs all steps—model creation, training, testing, and visualization—as a complete workflow.
