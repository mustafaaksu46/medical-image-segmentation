...
If you want to perform the steps in Step 3 separately, you should first run model.py, then train.py, and finally run either test_visual.py or test_visual_selected_images.py.
