...
4. (Optional) If you want to perform the steps in Step 3 separately, you should first run model_Patient_Based.py, then train_Patient_Based.py, and finally run test_visual_Patient_Based.py.
